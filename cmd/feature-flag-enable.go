...
var enableCmd = &cobra.Command{
	Use:   "enable",
	Short: "Enable a Knative feature flag",
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		if len(args) != 1 {
			fmt.Println("requires feature flag name")
			os.Exit(1)
		}

		if args[0] == "https-connection" {
			...
			fmt.Printf("feature flag %s not suppored\n", args[0])
		}
...
func init() {
	featureFlagCmd.AddCommand(enableCmd)
