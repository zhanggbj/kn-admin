...
admin domain update - to update Knative route domain to a custom domain
admin feature-flag list - to list all feature flags
admin feature-flag enable https-connection - to enable https connection
`,
